...
### 1. "FlexStart (left)" element overflows the container's left edge and rounded corner
**Type:** overflow
...
### 2. "FlexEnd (right)" element overflows the container's right edge and rounded corner
**Type:** overflow
**Screenshot:** idle_720p.png
