...
**Issue:** No way to render text with inline formatting, effects, or embedded content. Game UIs frequently need styled text with mixed formatting (bold keywords, colored names, inline icons, animated effects).

**Inspiration:** Godot's RichTextLabel with BBCode support.
...
## Large (~3-5 days)
- Rich Text Label (with animated effects)
- Focus Ring Styles
- Tab Bar
- Tree Node
- Modal/Dialog
