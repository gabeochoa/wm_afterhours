  ...
  void for_each_with(afterhours::Entity &entity,
    ...
    div(context, mk(entity, 1),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(screen_width), pixels(40.0f * scale)})
    ...
    div(context, mk(entity, 2),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(screen_width), pixels(24.0f * scale)})
            .with_absolute_position()
    ...
    div(context, mk(entity, 10),
        ComponentConfig{}
            ...
            .with_soft_shadow(4.0f * scale, 8.0f * scale, 20.0f * scale, afterhours::Color{0, 0, 0, 80})
    ...
    circular_progress(
        ...
        ComponentConfig{}
            ...
            .with_absolute_position()
            .with_translate(start_x + (card_width - ring_size) / 2, content_y + 50.0f * scale)
    ...
    circular_progress(
        ...
        ComponentConfig{}
            .with_size(ComponentSize{pixels(ring_size), pixels(ring_size)})
            .with_absolute_position()
            .with_translate(card2_x + (card_width - ring_size) / 2, content_y + 50.0f * scale)
    ...
    div(context, mk(entity, 23),
        ComponentConfig{}
            .with_label(fmt::format("{}%", static_cast<int>(animated_progress * 100)))
            .with_size(ComponentSize{pixels(card_width), pixels(24.0f * scale)})
            .with_absolute_position()
    ...
    circular_progress(
        ...
        ComponentConfig{}
            .with_size(ComponentSize{pixels(ring_size), pixels(ring_size)})
            .with_absolute_position()
            .with_translate(card3_x + (card_width - ring_size) / 2, content_y + 50.0f * scale)
    ...
    circular_progress(
        ...
        ComponentConfig{}
            .with_size(ComponentSize{pixels(ring_size), pixels(ring_size)})
            .with_absolute_position()
            .with_translate(card4_x + (card_width - ring_size) / 2, content_y + 50.0f * scale)
    ...
    afterhours::Color colors[] = {accent_cyan, accent_purple, accent_green, accent_orange, accent_pink};
    float progress_values[] = {0.25f, 0.50f, 0.75f, 0.90f, 1.0f};

    for (int i = 0; i < 5; i++) {
      float card_x = bottom_start_x + (small_card_width + small_gap) * static_cast<float>(i);
      float size = base_sizes[i] * scale;
      
      // Card background
      div(context, mk(entity, 110 + i),
          ComponentConfig{}
              .with_size(ComponentSize{pixels(small_card_width), pixels(small_card_height)})
              .with_absolute_position()
      ...
      circular_progress(
          ...
          ComponentConfig{}
              ...
              .with_translate(card_x + (small_card_width - size) / 2,
                              bottom_y + 15.0f * scale + (70.0f * scale - size) / 2)
      ...
      div(context, mk(entity, 130 + i),
          ComponentConfig{}
              ...
              .with_size(ComponentSize{pixels(small_card_width), pixels(20.0f * scale)})
              .with_absolute_position()
      ...
      div(context, mk(entity, 140 + i),
          ComponentConfig{}
              .with_label(fmt::format("{}%", static_cast<int>(progress_values[i] * 100)))
              .with_size(ComponentSize{pixels(small_card_width), pixels(16.0f * scale)})
              .with_absolute_position()
...
REGISTER_EXAMPLE_SCREEN(circular_progress, "Component Galleries",
