  ...
  void for_each_with(afterhours::Entity &entity,
    ...
    div(context, mk(entity, 6),
        ComponentConfig{}
            ...
            .with_absolute_position()
            .with_translate((float)screen_w - 180.0f, 14.0f)
    ...
    div(context, mk(entity, 7),
        ComponentConfig{}
            ...
            .with_absolute_position()
            .with_translate((float)screen_w - 175.0f, 18.0f)
    ...
    for (size_t i = 0; i < tabs.size(); i++) {
      ...
      if (button(context, mk(entity, 10 + static_cast<int>(i)),
                 ComponentConfig{}
                     ...
                     .with_absolute_position()
                     .with_translate(25.0f + (float)i * 140.0f, tab_y)
    ...
    div(context, mk(entity, 100),
        ComponentConfig{}
            .with_size(ComponentSize{pixels(static_cast<int>(list_w)),
                                     pixels(static_cast<int>(list_h))})
            .with_absolute_position()
            .with_translate(list_x, list_y)
            .with_custom_background(panel_purple)
            .with_border(border_purple, 2.0f)
    ...
    for (size_t i = 0; i < recipes.size(); i++) {
      ...
      if (button(
              ...
              ComponentConfig{}
                  .with_size(ComponentSize{
                      pixels(static_cast<int>(list_w - 20)), pixels(72)})
                  .with_absolute_position()
                  .with_translate(list_x + 10.0f, ry)
      ...
      div(context, mk(entity, 111 + static_cast<int>(i) * 4),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(list_x + 20.0f, ry + 8.0f)
      ...
      div(context, mk(entity, 112 + static_cast<int>(i) * 4),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(list_x + 70.0f, ry + 8.0f)
      ...
      div(context, mk(entity, 113 + static_cast<int>(i) * 4),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(list_x + 70.0f, ry + 32.0f)
      ...
      div(context, mk(entity, 114 + static_cast<int>(i) * 4),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(list_x + 70.0f, ry + 50.0f)
              .with_font("EqProRounded", h720(14.0f))
              .with_custom_text_color(muted)
    ...
    div(context, mk(entity, 200),
        ComponentConfig{}
            .with_size(ComponentSize{pixels(static_cast<int>(brew_w)),
                                     pixels(static_cast<int>(brew_h))})
            .with_absolute_position()
            .with_translate(brew_x, brew_y)
            .with_custom_background(panel_purple)
            .with_border(border_purple, 2.0f)
            .with_rounded_corners(std::bitset<4>(0b1111))
            .with_roundness(0.06f)
    ...
    div(context, mk(entity, 201),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(static_cast<int>(brew_w - 30)),
                                     pixels(30)})
            .with_absolute_position()
            .with_translate(brew_x + 15.0f, brew_y + 12.0f)
    ...
    div(context, mk(entity, 210),
        ComponentConfig{}
            .with_size(ComponentSize{pixels(static_cast<int>(flask_size)),
                                     pixels(static_cast<int>(flask_size))})
            .with_absolute_position()
            .with_translate(flask_x, flask_y)
    ...
    div(context, mk(entity, 211),
        ComponentConfig{}
            .with_size(ComponentSize{pixels(static_cast<int>(flask_size - 10)),
                                     pixels(static_cast<int>(fill_h))})
            .with_absolute_position()
            .with_translate(flask_x + 5.0f,
    ...
    div(context, mk(entity, 212),
        ComponentConfig{}
            ...
            .with_absolute_position()
            .with_translate(flask_x + (flask_size - 40.0f) / 2.0f,
                            flask_y - 22.0f)
            .with_custom_background(brew_bg)
            .with_border(border_purple, 2.0f)
    ...
    div(context, mk(entity, 220),
        ComponentConfig{}
            .with_size(ComponentSize{
                pixels(static_cast<int>(brew_w - 60)), pixels(24)})
            .with_absolute_position()
            .with_translate(brew_x + 30.0f, prog_y)
            .with_custom_background(brew_bg)
    ...
    div(context, mk(entity, 221),
        ComponentConfig{}
            .with_size(ComponentSize{
                ...
                pixels(20)})
            .with_absolute_position()
            .with_translate(brew_x + 33.0f, prog_y + 2.0f)
    ...
    div(context, mk(entity, 222),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(static_cast<int>(brew_w - 60)),
                                     pixels(22)})
            .with_absolute_position()
            .with_translate(brew_x + 30.0f, prog_y + 28.0f)
    ...
    div(context, mk(entity, 230),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(static_cast<int>(brew_w - 60)),
                                     pixels(22)})
            .with_absolute_position()
            .with_translate(brew_x + 30.0f, slots_y)
    ...
    for (size_t i = 0; i < sel_recipe.required.size(); i++) {
      ...
      div(context, mk(entity, 240 + static_cast<int>(i) * 3),
          ComponentConfig{}
              .with_size(ComponentSize{pixels(static_cast<int>(slot_size)),
                                       pixels(static_cast<int>(slot_size))})
              .with_absolute_position()
              .with_translate(sx, sy)
      ...
      div(context, mk(entity, 241 + static_cast<int>(i) * 3),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(sx + 12.0f, sy + 5.0f)
      ...
      div(context, mk(entity, 242 + static_cast<int>(i) * 3),
          ComponentConfig{}
              ...
              .with_size(ComponentSize{pixels(static_cast<int>(slot_size)),
                                       pixels(18)})
              .with_absolute_position()
              .with_translate(sx, sy + slot_size - 20.0f)
              .with_font("EqProRounded", h720(14.0f))
    ...
    button(context, mk(entity, 250),
           ComponentConfig{}
               ...
               .with_absolute_position()
               .with_translate(brew_x + (brew_w - 160.0f) / 2.0f, brew_btn_y)
    ...
    div(context, mk(entity, 300),
        ComponentConfig{}
            .with_size(ComponentSize{pixels(static_cast<int>(inv_w)),
                                     pixels(static_cast<int>(inv_h))})
            .with_absolute_position()
            .with_translate(inv_x, inv_y)
            .with_custom_background(panel_purple)
            .with_border(border_purple, 2.0f)
            .with_rounded_corners(std::bitset<4>(0b1111))
            .with_roundness(0.06f)
    ...
    div(context, mk(entity, 301),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(static_cast<int>(inv_w - 20)),
                                     pixels(28)})
            .with_absolute_position()
            .with_translate(inv_x + 10.0f, inv_y + 10.0f)
            .with_font("Gaegu-Bold", h720(22.0f))
            .with_custom_text_color(accent_gold)
            .with_alignment(TextAlignment::Center)
    ...
    for (size_t i = 0; i < ingredients.size(); i++) {
      ...
      div(context, mk(entity, 310 + static_cast<int>(i) * 3),
          ComponentConfig{}
              .with_size(
                  ComponentSize{pixels(static_cast<int>(inv_cell_w - 5)),
                                pixels(static_cast<int>(inv_cell_h - 5))})
              .with_absolute_position()
              .with_translate(ix, iy)
      ...
      div(context, mk(entity, 311 + static_cast<int>(i) * 3),
          ComponentConfig{}
              ...
              .with_absolute_position()
              .with_translate(ix + 8.0f, iy + 8.0f)
      ...
      div(context, mk(entity, 312 + static_cast<int>(i) * 3),
          ComponentConfig{}
              ...
              .with_size(ComponentSize{pixels(static_cast<int>(inv_cell_w - 55)),
                                       pixels(40)})
              .with_absolute_position()
              .with_translate(ix + 46.0f, iy + 8.0f)
              .with_font("EqProRounded", h720(14.0f))
              .with_custom_text_color(white)
