  ...
  void for_each_with(afterhours::Entity &entity,
    ...
    if (button(context, mk(entity, 20),
               ComponentConfig{}
                   ...
                   .with_rounded_corners(std::bitset<4>(0b1111))
                   .with_roundness(0.15f)
                   .with_animation(Anim::on_click().scale(1.0f, 0.85f).spring(15.0f, 10.0f))
    ...
    if (button(context, mk(entity, 30),
               ComponentConfig{}
                   ...
                   .with_rounded_corners(std::bitset<4>(0b1111))
                   .with_roundness(0.15f)
                   .with_animation(Anim::on_hover().scale(1.0f, 1.1f).ease_out(0.08f))
                   .with_animation(Anim::on_click().scale(1.0f, 0.9f).spring(18.0f, 12.0f))
    ...
    div(context, mk(entity, 40),
        ComponentConfig{}
            ...
            .with_size(ComponentSize{pixels(button_size), pixels(button_size)})
            .with_absolute_position()
            .with_translate(btn4_x, button_y)
    ...
    div(context, mk(entity, 90),
        ComponentConfig{}
            ...
            .with_absolute_position()
            .with_translate(center_x - 100.0f, row3_y + button_size + 20.0f)
            .with_font(UIComponent::DEFAULT_FONT, h720(18.0f))
            .with_background(Theme::Usage::Surface)
            .with_custom_text_color(text_light)
            .with_alignment(TextAlignment::Center)
    ...
    div(context, mk(entity, 100),
        ComponentConfig{}
            .with_label("Old: ~50 lines of boilerplate | New: .with_animation(Anim::on_hover().scale(1.1f).spring())")
            .with_size(ComponentSize{pixels(screen_w), pixels(30)})
            .with_absolute_position()
            .with_translate(0.0f, screen_h - 50.0f)
            .with_font(UIComponent::DEFAULT_FONT, h720(14.0f))
            .with_background(Theme::Usage::Surface)
            .with_custom_text_color(text_light)
            .with_alignment(TextAlignment::Center)
